...
var vote_endpoint = "https://<YOUR-API>.execute-api.<REGION>.amazonaws.com/<STAGE>/song/vote"
var get_votes_endpoint = "https://<YOUR-API>.execute-api.<REGION>.amazonaws.com/<STAGE>/votes"
...
async function refreshVoteCounts() {
    ...
    for (i = 0; i < songs.length; i++){
      var featured_songs = ["likeglue", "ironlionzion", "alone"];
      var song = songs[i]
